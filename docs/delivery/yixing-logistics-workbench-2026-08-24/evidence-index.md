...
| `evidence/g7-target-application-confirmation.json` | Product-owner target application confirmation | `ZHLDEMO` confirmed dedicated; credential rotation unresolved |
