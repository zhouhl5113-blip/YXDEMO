...
| 10 | Foundation 0 delivery/security baseline | NFR-001..008 evidence | Target Harness scope, infrastructure/connectors and approved G7-GAP/ADR set |

Local progress in this batch: US-001 has a synthetic server-owned session/BFF boundary; US-004 has a responsive synthetic-data workbench shell; US-005..008 now have local dispatch domain and BFF/UI slices. TEST-013, TEST-014, TEST-015, TEST-017, TEST-018 and TEST-021..023 pass with unit, smoke or browser evidence. TEST-016 is partial because local validation passes while the database constraint and migration execution remain closed. US-008 remains partial because the durable Outbox/worker/monitor and signed G7 behavior are not active. Real authentication, RLS, persistent audit, signed G7 facts/write/readback and business acceptance remain blocked.
