...
- Local checkout: `D:\Harness\YXDEMO`; verified source baseline commit `c94ca688b869a8cb7f624ccee845728d9bc3bd6b` is published on `codex/product-assets-baseline`.
- Because the remote was empty, GitHub made that first branch the default. There is no distinct base branch for a Draft PR yet.
...
The published commit is an evidence/source baseline only. It is not a runnable product or release candidate.
